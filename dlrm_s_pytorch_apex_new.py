...
if __name__ == "__main__":
    ...
    parser.add_argument("--loss_scale", type=int, required=False, default=1)
    ...
    if args.fp16:
        ...
        (dlrm.top_l, dlrm.bot_l), optimizer = amp.initialize([dlrm.top_l, dlrm.bot_l], optimizer, opt_level="O2", loss_scale=1)
        print ("******** FP16 Model is ************ ")
        print (dlrm)
